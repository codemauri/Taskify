...
try {
  ...
  // Insert projects
  db.exec(`
    INSERT OR IGNORE INTO Project (id, title, description, userId, createdAt, updatedAt) 
    VALUES 
  ...
  db.exec(`
    INSERT OR IGNORE INTO Task (id, title, description, status, projectId, createdAt, updatedAt) 
    VALUES 
